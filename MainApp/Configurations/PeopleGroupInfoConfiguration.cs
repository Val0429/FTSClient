...
namespace Tencent.Configurations {
    public class PeopleGroupInfoConfiguration : IConfigurationSectionHandler {
        public object Create(object parent, object configContext, XmlNode section) {
            var items = ConvertNode<List<PeopleGroup>>(section, new XmlRootAttribute("PeopleGroupInfo"));
            return items;
        }
